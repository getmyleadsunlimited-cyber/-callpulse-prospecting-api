...
CREATE TABLE IF NOT EXISTS prospects (
  ...
  industry VARCHAR(100) NOT NULL CHECK (industry IN ('eCommerce','Roofing','HVAC','Dental','Garage Door Repair','Plumbing','Emergency Towing','Water Restoration','Mold Remediation','Pest Control','Electrical','Foundation Repair','Tree Service','Pool Service','Landscaping / Lawn Care','Med Spa','Final Expense','Auto Insurance')),
  location VARCHAR(200) NOT NULL DEFAULT 'Houston, TX',
  score INTEGER NOT NULL CHECK (score BETWEEN 65 AND 100), why_now TEXT NOT NULL,
