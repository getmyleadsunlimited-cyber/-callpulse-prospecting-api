...
SELECT DISTINCT ON (primary_workspace_id) primary_workspace_id, account_id, account_type
FROM users ORDER BY primary_workspace_id, id ON CONFLICT (id) DO NOTHING;
